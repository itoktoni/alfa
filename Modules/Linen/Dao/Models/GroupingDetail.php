...
class GroupingDetail extends Model
{
    ...
    {
        $this->attributes[$this->mask_barcode()] = $value;
    }

    public function getMaskBarcodeAttribute()
    {
        return $this->{$this->mask_barcode()};
    }

    public function mask_rfid()
    {
        return 'linen_grouping_detail_rfid';
    }
    ...
    {
        return $this->linen_grouping_detail_scan_location_name;
    }

    public function mask_location_ori()
    {
        return 'linen_grouping_detail_ori_location_id';
    }
    ...
    {
        return $this->linen_grouping_detail_ori_location_name;
    }
    ...
    {
        return 'linen_grouping_detail_scan_company_id';
    }
    ...
    {
        return 'linen_grouping_detail_product_id';
    }
    ...
    {
        return $this->linen_grouping_detail_product_name;
    }
