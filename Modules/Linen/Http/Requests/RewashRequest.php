...
class RewashRequest extends GeneralRequest
{
    ...
    public function prepareForValidation()
    {
        ...
        $location = LocationFacades::find($this->linen_rewash_location_id);
        ...
        $validate = $linen->map(function ($item) use($company, $location) {
            ...
            $data = [
                ...
                'linen_rewash_detail_scan_location_id' => $location->location_id ?? '',
                'linen_rewash_detail_scan_location_name' => $location->location_name ?? '', 
        ...
        $this->merge([  
            ...
            'linen_rewash_location_name' => $location->company_name ?? '',
