...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has('linen_opname_date') ? 'has-error' : ''}}">
    ...
    <div class="col-md-4 {{ $errors->has('linen_opname_company_id') ? 'has-error' : ''}}">
...
<div class="form-group">
    ...
    {!! Form::label('name', __('Petugas'), ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4 {{ $errors->has('linen_opname_petugas_id') ? 'has-error' : ''}}">
        {{ Form::select('linen_opname_petugas_id', $user, null, ['class'=> 'form-control ']) }}
        {!! $errors->first('linen_opname_petugas_id', '<p class="help-block">:message</p>') !!}
    </div>

    {!! Form::label('name', __('Status'), ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4 {{ $errors->has('linen_opname_status') ? 'has-error' : ''}}">
