        ...
        var oTable = $('#datatable').DataTable({
            ...
            url: '{{ route($route_data) }}',
                ...
                data: function(d) {
                    ...
                    d.linen_retur_key = $('input[name=linen_retur_key]').val();
                    d.linen_retur_created_at = $('input[name=linen_retur_created_at]').val();
                    d.linen_retur_company_id = $('select[name=linen_retur_company_id]').val();
                    d.linen_retur_created_by = $('select[name=linen_retur_created_by]').val();
                },
                        ...
                        <div class="group-search">
                            <div class="form-group">
                                ...
                                <div class="col-md-3 col-sm-2">
                                    ...
                                    {!! Form::text('linen_retur_key', null, ['class' => 'form-control', 'id' => 'linen_retur_key']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-2 {{ $errors->has($search_code) ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::text('linen_retur_created_at', old('linen_retur_created_at') ?? date('Y-m-d'), ['class' => 'form-control date', 'id' => 'linen_retur_created_at']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-2 {{ $errors->has($search_code) ? 'has-error' : ''}}">
                                    ...
                                    {{ Form::select('linen_retur_created_by', $user, null, ['class'=> 'form-control ']) }}
                                    </div>
                                </div>
