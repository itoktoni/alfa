...
class HistoryLinen extends Model
{
    use Userstamps, FilterQueryString, HasFactory, SoftDeletes;
    protected $table = 'view_history_linen';
    ...
    public $with = ['has_linen', 'has_linen.has_user'];
    ...
    public function mask_weight()
    {
        return 'company_item_weight';
    }

    public function setMaskWeightAttribute($value)
    {
        $this->attributes[$this->mask_weight()] = $value;
    }

    public function getMaskWeightAttribute()
    {
        return $this->{$this->mask_weight()};
    }

    public function mask_target()
    {
        return 'company_item_target';
    }

    public function setMaskTargetAttribute($value)
    {
        $this->attributes[$this->mask_target()] = $value;
    }

    public function getMaskTargetAttribute()
    {
        return $this->{$this->mask_target()};
    }
    ...
    public function getMaskCreatedDateAttribute()
    {
