...
<div class="form-group">
    ...
    <div class="col-md-4 col-sm-4 {{ $errors->has('item_linen_rent') ? 'has-error' : ''}}">
        {{ Form::select('item_linen_rent', $rental, old('item_linen_rent') ?? request()->get('item_linen_rent') ?? null, ['class'=> 'form-control ']) }}
...
<div class="form-group">
    ...
    <div class="col-md-4 col-sm-4 {{ $errors->has('item_linen_created_by') ? 'has-error' : ''}}">
        {{ Form::select('item_linen_created_by', $user, old('item_linen_created_by') ?? request()->get('item_linen_created_by') ?? null, ['class'=> 'form-control ']) }}
    ...
    <div class="col-md-4 col-sm-4 {{ $errors->has('item_linen_status') ? 'has-error' : ''}}">
        {{ Form::select('item_linen_status', $status, old('item_linen_status') ?? request()->get('item_linen_status') ?? null, ['class'=> 'form-control ']) }}
