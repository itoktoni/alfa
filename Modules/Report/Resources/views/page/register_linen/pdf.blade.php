...
<head>
    ...
    *:after {
    ...
    .bukalapak-transaction-product-report {
        width: 80%
    }
    ...
    #container table .report td {
        vertical-align: middle !important;
    }


    #container table .report .no {
        text-align: center;
    }

    #container table .report .qty {
        text-align: right;
    }

    #container table .report .price {
        text-align: right;
    }

    #container table .report .total {
        text-align: right;
    }

    #container table .report .total span {
        position: relative;
        font-weight: bold;
        display: block;
        right: 0px;
    ...
    #container table .report .product h1 {
        font-size: 12px;
        margin: 0px;
    }

    #container table .report .product h2 {
        font-size: 10px;
        font-weight: bold;
        margin: 0px;
    }

    #container table .report .product h3 {
        font-size: 10px;
        text-align: left;
        font-weight: bold;
        margin: 0px;
    ...
    #container table .report .product p {
        font-size: 10px;
        text-align: left;
        margin: 0px;
    }

    #container table .report .product span {
        position: relative;
        font-weight: bold;
        display: block;
        right: 0px;
