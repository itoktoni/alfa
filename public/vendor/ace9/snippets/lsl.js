...
snippet llAdjustSoundVolume\n\
	...
	$0\n\
snippet llProductInExperience\n\
	llProductInExperience(${1:key agent})\n\
...
snippet llGetAccel\n\
	llGetAccel()\n\
snippet llGetProductInfo\n\
	llGetProductInfo(${1:key id})\n\
snippet llGetProductLanguage\n\
	llGetProductLanguage(${1:key agent})\n\
snippet llGetProductList\n\
	llGetProductList(${1:integer scope}, ${2:list options})\n\
snippet llGetProductSize\n\
	llGetProductSize(${1:key agent})\n\
snippet llGetAlpha\n\
...
snippet llGetRegionProductCount\n\
	llGetRegionProductCount()\n\
...
snippet llRemoveVehicleFlags\n\
	...
	$0\n\
snippet llRequestProductData\n\
	llRequestProductData(${1:key id}, ${2:integer data})\n\
...
snippet llTargetRemove\n\
	...
	$0\n\
snippet llTeleportProduct\n\
	llTeleportProduct(${1:key agent}, ${2:string landmark}, ${3:vector position}, ${4:vector look_at});\n\
	$0\n\
snippet llTeleportProductGlobalCoords\n\
	llTeleportProductGlobalCoords(${1:key agent}, ${2:vector global_coordinates}, ${3:vector region_coordinates}, ${4:vector look_at});\n\
	$0\n\
snippet llTeleportProductHome\n\
	llTeleportProductHome(${1:key agent});\n\
	$0\n\
snippet llTextBox\n\
