...
<div id="register" class="cartoon-container">
...
{!! Form::open(['id' => 'register', 'class' => 'form login']) !!}

<div class="form__field form__field--email">
    <div class="form__input-wrapper">
        {!! Form::text('username', null, ['autofocus', 'class' => 'form__input','id' => 'login__email','placeholder' =>
        'Username']) !!}
    </div>
</div>
...
<div class="form__field form__field--email">
    <div class="form__input-wrapper">
        {!! Form::text('name', null, ['autofocus', 'class' => 'form__input','id' => 'login__email','placeholder' =>
        'Full Name']) !!}
    </div>
</div>
