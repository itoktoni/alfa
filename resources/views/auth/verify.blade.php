...
<form class="form login" id="auth" role="form" method="POST" action="{{ route('verification.resend') }}">
    {{ csrf_field() }}

    <div class="form__field form__field--email">
        <div class="form__input-wrapper">
            {!! Form::text('', null, ['class' => 'form__input','id' =>
            'login__email','placeholder' =>
            'Please Press Send Link !', 'disabled']) !!}
        </div>
    </div>
