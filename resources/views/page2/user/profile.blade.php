                        ...
                        <div class="panel-group" id="accordion">
                            ...
                            <div class="panel panel-accordion">
                                ...
                                <div id="address" class="accordion-body collapse">
                                    <div class="panel-body line">
                                        <div class="col-md-12">
                                            <select name="area" id="chosen" class="form-control">
                                                <option value="{{ $area->rajaongkir_area_id ?? '' }}">
                                                    {{ $area->rajaongkir_area_province_name.' - '.$area->rajaongkir_area_city_name.' - '.$area->rajaongkir_area_name ?? 'Please Search Area' }}
                                                </option>
                                            </select>
                                        </div>
                                        <hr>
                                    ...
                                    <div class="panel-body line">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    {{ Form::select('site', $site, $model->site ?? null, ['class'=> 'form-control']) }}
                                                </div>
