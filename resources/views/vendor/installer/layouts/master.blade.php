...
<html>
    <head>
        ...
        <link rel="icon" type="image/png" href="{{ Helper::asset('/installer/img/favicon/favicon-16x16.png') }}" sizes="16x16"/>
        <link rel="icon" type="image/png" href="{{ Helper::asset('/installer/img/favicon/favicon-32x32.png') }}" sizes="32x32"/>
        <link rel="icon" type="image/png" href="{{ Helper::asset('/installer/img/favicon/favicon-96x96.png') }}" sizes="96x96"/>
        <link href="{{ Helper::asset('/installer/css/style.min.css') }}" rel="stylesheet"/>
        @yield('style')
        <script>
